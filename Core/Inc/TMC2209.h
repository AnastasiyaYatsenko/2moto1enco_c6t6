...
public:
	...
	void setup(UART_HandleTypeDef *tmc_uart,long serial_baud_rate = 115200,SerialAddress serial_address = SERIAL_ADDRESS_0);
...
//	void serialFlush();
	...
	const static uint32_t ECHO_DELAY_INC_MICROSECONDS = 1; //1
